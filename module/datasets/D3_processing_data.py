...
class Pty3Rating:
    ...
    def download(self):
        ...
        rating_file = os.path.join(self.root_path, "processing", "D3-pty3ratings.xlsx")
        trust_file = os.path.join(self.root_path, "processing", "D3-pty3trust.xlsx")
        mistrust_file = os.path.join(self.root_path, "processing", "D3-pty3mistrust.xlsx")
    ...
    def processing_ratings(self):
        ...
        drop_row_index_list = list(count_row_nonzero[count_row_nonzero <= 30].index)
        drop_col_index_list = list(count_col_nonzero[count_col_nonzero <= 4].index)
        ...
        user_item_pivot.to_excel(os.path.join(self.root_path, "processing", "D3-pty3ratings.xlsx"),
                                 index=False,
                                 header=False)
    ...
    def processing_trust(self, drop_row_index_list):
        ...
        # Export data to excel sheet
        user_trust_dataset.to_excel(os.path.join(self.root_path, "processing", "D3-pty3trust.xlsx"),
    ...
    def processing_mistrust(self, user_trust_dataset):
        ...
        # Export data to excel sheet
        user_mistrust_dataset.to_excel(os.path.join(self.root_path, "processing", "D3-pty3mistrust.xlsx"),
                                       index=False, header=False)
