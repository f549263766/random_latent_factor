...
class Pty5Rating:
    ...
    def download(self):
        ...
        rating_file = os.path.join(self.root_path, "processing", "D5-pty5ratings.xlsx")
        trust_file = os.path.join(self.root_path, "processing", "D5-pty5trust.xlsx")
        mistrust_file = os.path.join(self.root_path, "processing", "D5-pty5mistrust.xlsx")
    ...
    def processing_ratings(self):
        ...
        user_ratings_dataset = user_ratings_dataset.drop(
            user_ratings_dataset[user_ratings_dataset['movie'] > 943].index, axis=0)
        ...
        user_item_pivot.to_excel(os.path.join(self.root_path, "processing", "D5-pty5ratings.xlsx"),
                                 index=False,
                                 header=False)
    ...
    def processing_trust(self, drop_row_index_list):
        ...
        # Export data to excel sheet
        user_trust_dataset.to_excel(os.path.join(self.root_path, "processing", "D5-pty5trust.xlsx"),
    ...
    def processing_mistrust(self, user_trust_dataset):
        ...
        # Export data to excel sheet
        user_mistrust_dataset.to_excel(os.path.join(self.root_path, "processing", "D5-pty5mistrust.xlsx"),
                                       index=False, header=False)
