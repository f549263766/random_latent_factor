...
class Pty6Rating:
    ...
    def download(self):
        ...
        rating_file = os.path.join(self.root_path, "processing", "D6-pty6ratings.xlsx")
        trust_file = os.path.join(self.root_path, "processing", "D6-pty6trust.xlsx")
        mistrust_file = os.path.join(self.root_path, "processing", "D6-pty6mistrust.xlsx")
    ...
    def processing_ratings(self):
        ...
        user_ratings_dataset = pd.read_excel(self.user_rating_data_path, sheet_name="D6-movie-ratings")
        ...
        user_ratings_dataset = user_ratings_dataset.drop(
            user_ratings_dataset[user_ratings_dataset['movie'] > 671].index, axis=0)
        ...
        drop_row_index_list = list(count_row_nonzero[count_row_nonzero <= 10].index)
        drop_col_index_list = list(count_col_nonzero[count_col_nonzero <= 10].index)
        ...
        user_item_pivot.to_excel(os.path.join(self.root_path, "processing", "D6-pty6ratings.xlsx"),
                                 index=False,
                                 header=False)
    ...
    def processing_trust(self, drop_row_index_list):
        ...
        # Export data to excel sheet
        user_trust_dataset.to_excel(os.path.join(self.root_path, "processing", "D6-pty6trust.xlsx"),
    ...
    def processing_mistrust(self, user_trust_dataset):
        ...
        # Export data to excel sheet
        user_mistrust_dataset.to_excel(os.path.join(self.root_path, "processing", "D6-pty6mistrust.xlsx"),
                                       index=False, header=False)
