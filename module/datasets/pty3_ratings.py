...
class Pty3Rating:
    ...
    def download(self):
        ...
        mistrust_file = os.path.join(self.root_path, "pty3mistrust.xlsx")
    ...
    def processing_ratings(self):
        ...
        user_item_pivot.to_excel(os.path.join(self.root_path, "pty3ratings.xlsx"), index=False, header=False)
    ...
    def processing_trust(self, drop_row_index_list):
        ...
        # Export data to excel sheet
        user_trust_dataset.to_excel(os.path.join(self.root_path, "pty3trust.xlsx"), index=False, header=False)
    ...
    def processing_mistrust(self, user_trust_dataset):
        ...
        # Export data to excel sheet
        user_mistrust_dataset.to_excel(os.path.join(self.root_path, "pty3mistrust.xlsx"), index=False, header=False)
